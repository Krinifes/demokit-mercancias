		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "almacen",
									"targetURL": "#almacenalmacen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"almacenalmacen-display": {
								"semanticObject": "almacenalmacen",
								"action": "display",
								"description": "almacen",
								"title": "almacen",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=almacen.almacen",
									"url": sap.ui.require.toUrl("almacen/almacen")
								}
							}
						}
					}
